...
import 'package:taxi_app/ui/contact_to_driver/sub_screens/for_audio/audiocontroller.dart';
import 'package:taxi_app/ui/contact_to_driver/sub_screens/for_audio/chat_controller.dart';
...
class _VoiceChatState extends State<VoiceChat> {
  ...
  Widget _audio({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isCurrentUser ? Colors.red : Colors.red.withOpacity(0.18),
              ...
              Row(
                children: <Widget>[
                  isLastMessageLeft(index)
                      ...
                      : Container(width: 35),
                  if (messageChat.type == TypeMessage.text)
                    if (messageChat.type == TypeMessage.image) Placeholder(),
                  if (messageChat.type == TypeMessage.audio)
                    _audio(
                        message: messageChat.content,
                        isCurrentUser: messageChat.idFrom == currentUserId,
