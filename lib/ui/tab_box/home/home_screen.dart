...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override
  void initState() {
    initialCameraPosition = CameraPosition(target: BlocProvider.of<LocationBloc>(context).latLong!,zoom: 13);
    currentCameraPosition = CameraPosition(target: BlocProvider.of<LocationBloc>(context).latLong!,zoom: 13);
    super.initState();
  }
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: 0,
                right: 0,
                child:  CategoryOfAddress(latLng: currentCameraPosition.target,),
              ),
              Positioned(
                bottom: 0,
                left: 0,
