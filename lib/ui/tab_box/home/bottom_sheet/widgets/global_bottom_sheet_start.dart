...
class GlobalBottomSheetStart extends StatelessWidget {
  const GlobalBottomSheetStart({super.key, required this.centerText, required this.name, required this.carName, required this.starCount, required this.carNumber, required this.commentTitle, required this.commentSubtitle});
